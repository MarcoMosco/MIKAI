          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                value: _spedizione,
                decoration: const InputDecoration(
                    labelText: 'Note per la spedizione *'),
                items: const [
                  DropdownMenuItem(
                      value: null,
                      ...
                      enabled: false),
                  DropdownMenuItem(
                      value: 'Spedizione diretta',
                      child: Text('Spedizione diretta')),
                  DropdownMenuItem(
                      value: 'Fermo DHL', child: Text('Fermo DHL')),
                  DropdownMenuItem(
                      value: 'Fermo TNT', child: Text('Fermo TNT')),
                ],
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Dettagli aggiuntivi spedizione'),
                minLines: 1,
                maxLines: 3,
              ),
              const SizedBox(height: 16),
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: 'Reintegro', child: Text('Reintegro')),
                  DropdownMenuItem(
                      value: 'Intervento spot', child: Text('Intervento spot')),
                ],
                validator: (v) => v == null ? 'Campo obbligatorio' : null,
                onChanged: (v) {
                  setState(() => _causale = v);
              ...
              Row(
                children: [
                  Expanded(
                    child: FormField<DateTime>(
                      ...
                      builder: (field) => InkWell(
                        onTap: () => _selectDate(context, _dataIntervento,
                            (d) => setState(() => _dataIntervento = d)),
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () => _selectDate(context, _dataConsegna,
                          (d) => setState(() => _dataConsegna = d)),
                      child: InputDecorator(
                        decoration: const InputDecoration(
                            labelText: 'Data consegna di preferenza'),
                        child: Text(
                          _dataConsegna == null
                              ? 'Seleziona data'
                              : _dataConsegna!
              ...
              Row(
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: () => _selectDate(context, _dataRitiro,
                          (d) => setState(() => _dataRitiro = d)),
                      child: InputDecorator(
                        decoration:
                            const InputDecoration(labelText: 'Data ritiro'),
                        child: Text(
                          _dataRitiro == null
                              ? 'Seleziona data'
                              : _dataRitiro!.toLocal().toString().split(' ')[0],
                          style: TextStyle(
                            color: _dataRitiro == null
                                ? Colors.grey
                                : Colors.black,
                          ),
                        ),
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: 'Nominativo di contatto per il ritiro'),
                    ),
                  ),
                ],
              ),
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      _formValid ? const Color(0xFFB1001A) : Colors.grey[300],
                  foregroundColor: _formValid ? Colors.white : Colors.grey[700],
                  padding: const EdgeInsets.symmetric(vertical: 16),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8),
                  ),
                  elevation: _formValid ? 2 : 0,
                ),
                onPressed: _formValid
                    ? () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const ArticoliScreen()),
                        );
                      }
                    : null,
                child: Text(
