      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Produzione dispositivi medico chirurgici per ortopedia e traumatologia',
              style: GoogleFonts.roboto(
                fontSize: 14,
              ...
              child: GridView.count(
                ...
                children: [
                  _buildUserButton(
                    ...
                    title: 'Nuovo Ordine',
                    subtitle: 'Inserisci una nuova richiesta',
                    color: Colors.blue,
                    onTap: () {
                      Navigator.push(
                        context,
                  ...
                  _buildUserButton(
                    ...
                    icon: Icons.list_alt,
                    title: 'I Miei Ordini',
                    subtitle: 'Visualizza ordini in corso',
                    color: Colors.green,
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text(
                                'I Miei Ordini - Funzionalità in fase di sviluppo')),
                      );
                    },
                  ),
                  _buildUserButton(
                    ...
                    icon: Icons.history,
                    title: 'Storico',
                    subtitle: 'Archivio ordini completati',
                    color: Colors.orange,
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text(
                                'Storico - Funzionalità in fase di sviluppo')),
                      );
                    },
                  ),
                  _buildUserButton(
                    ...
                    title: 'Notifiche',
                    subtitle: 'Centro comunicazioni',
                    color: Colors.red,
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text(
                                'Notifiche - Funzionalità in fase di sviluppo')),
                      );
                    },
                  ),
                ],
...
class _AnimatedAdminStatButton extends StatefulWidget {
  ...
  @override
  State<_AnimatedAdminStatButton> createState() =>
      _AnimatedAdminStatButtonState();
}

class _AnimatedAdminStatButtonState extends State<_AnimatedAdminStatButton>
...
class _AnimatedAdminActionButton extends StatefulWidget {
  ...
  @override
  State<_AnimatedAdminActionButton> createState() =>
      _AnimatedAdminActionButtonState();
}

class _AnimatedAdminActionButtonState extends State<_AnimatedAdminActionButton>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _scaleAnim;
